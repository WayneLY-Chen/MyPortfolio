...
const KNOWLEDGE = [
  ...
  {
    content: '這個個人網站技術棧：前端 React + Vite + GSAP + ScrollTrigger，後端 Node.js + Express，資料庫 PostgreSQL + Supabase。',
  ...
  {
    content: 'Wayne 的工作經歷：摩斯漢堡訓練員（2018/08 - 2023/06），華碩電腦系統品質軟體工程師實習生（2023/06 - 2025/06）。',
    metadata: { topic: 'experience' }
  },
  {
    content: 'Wayne 的技能包含：React / Next.js、GSAP、Node.js、TypeScript、Python、AI / Machine Learning、UI/UX Design、Figma、MySQL、Git。',

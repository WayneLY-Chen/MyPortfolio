...
export default function TopNav() {
  ...
  useEffect(() => {
    ...
    if (open) {
      ...
      // iOS Safari 的半透明工具列只會透出「捲動層」的內容，
      // 選單打開時隱藏主內容，工具列後面才會是純底色
  ...
  // 元件卸載（路由切換）時確保主內容恢復顯示
  useEffect(() => () => document.body.classList.remove('nav-menu-open'), [])
  ...
  return (
    <>
      <style>{`
        ...
        .nav-icon { height: 34px; width: auto; object-fit: contain; display: block; }
        ...
        .nav-links-center li button {
          ...
          color: #999; transition: all 0.3s; padding: 8px 0;
          font-weight: 500;
        }
        ...
        @media (max-width: 900px) {
          ...
          /* 手機版：透明極簡 NAV，右側只留登入＋GitHub＋漢堡選單，不擋內容 */
        ...
        body.nav-menu-open main { visibility: hidden; }
      `}</style>

...
const SKILLS = [
  ...
  { name: 'Next.js', icon: 'https://cdn.simpleicons.org/nextdotjs/f5ede0' },
  ...
  { name: 'Langflow', icon: 'https://cdn.simpleicons.org/langflow' },
  ...
  { name: 'Celery', icon: 'https://cdn.simpleicons.org/celery' },
